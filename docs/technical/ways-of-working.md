...
2. **Automated checks** — runs `pnpm format`, `pnpm lint`, `pnpm build`, `pnpm knip`, and `pnpm test`, fixing issues as needed
...
- `pnpm knip` — must pass with zero unused exports or files
